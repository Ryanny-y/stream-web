...
export const FavoriteVideoCard: React.FC<FavoriteVideoCardProps> = ({
  item,
  onRemove,
  onWatchlist,
  isInWatchlist,
      ...
      <div className="space-y-3 p-4">
        <div>
          ...
          <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-gray-400">
            ...
            <span>Favorited {formatDate(item.addedAt)}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="icon"
            variant="outline"
            className="h-9 w-9 border-white/10 bg-primary/15 text-primary hover:bg-primary/20 hover:text-primary"
